export const translations = {
    ...
    ru: {
        ...
        "manifesto.title":
            "ИНТЕРНЕТ<br>ЕЩЁ НИКОГДА<br><em>НЕ БЫЛ ТАКИМ НЕЖНЫМ.</em>",

        "manifesto.mono":
            "РУЧНАЯ РАБОТА. СТРАННО. БЕСПОЛЕЗНО. ДОРОГО.<br>ИМЕННО ТАК, КАК И ДОЛЖНО БЫТЬ.",
        ...
        "process.taft.text":
            "Сотни тысяч петель пряжи, набитых вручную.",

        "process.carve.title":
            "КАРВИНГ",

        "process.carve.text":
            "Каждая деталь вырезается вручную, пока изображение не оживёт.",
        ...
        "about.title":
            "СЛИШКОМ МНОГО<br>МЕМОВ.<br><em>НЕДОСТАТОЧНО<br>КОВРОВ.</em>",
